...
class DataGenerator:
    """Generate realistic dataset for Decision Tree: Medical Diagnosis System"""
...
def main():
    """Main function demonstrating Decision Tree: Medical Diagnosis System"""
    print_header()
...
# This project implements Decision Tree completely from scratch.
# 
# Key Dependencies:
...
# 
# Educational Notes:
# 1. Decision trees create interpretable rules for classification
# 2. Information gain guides optimal feature selection
# 3. Tree pruning prevents overfitting to training data
